...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','ali1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','ali2.jpg');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','ali3.jpg');
     }
 });
...
<?php } ?>
			...
			<div class="row">
				...
				<div class="col-sm-5" style="margin-top: 60px">
					...
					<div class="col-sm-7" id="" style="max-width: 100%;max-height: 300px;padding-top:38px;">

<div class="aa" style="height: 20px;p;margin-bottom:8px;">
        ...
        <span class="three" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="ali1.png" width="100%" style="margin: 0 auto;padding-bottom:30px; -webkit-filter: grayscale(100%); /* Safari 6.0 - 9.0 */
