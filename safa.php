...
<html>
<head>
  <title>safa residence landscape</title>
  <meta charset="utf-8">
...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','safa11.jpg');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','safa2.jpg');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','safa3.jpg');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','safa4.jpg');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
       ...
       <span class="four" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="safa11.jpg" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
