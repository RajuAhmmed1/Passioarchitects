...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','boro1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','boro2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','boro3.png');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','boro4.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="four" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="boro1.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
