...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','abu1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','abu2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','abu3.png');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','abutaleb.jpg');
 ...
 $('.five').on({
     'click': function(){
         $('#change-image').attr('src','abutaleb1.jpg');
     }
 });

  $('.six').on({
     'click': function(){
         $('#change-image').attr('src','a.jpg');
     }
 });
   $('.seven').on({
     'click': function(){
         $('#change-image').attr('src','b.jpg');
     }
 });
});
...
<?php } ?>
			...
			<div class="row">
				...
				<div class="col-sm-5" style="margin-top: 60px">
					...
					<div class="col-sm-7" id="" style="max-height: 300px;padding-top:38px;">
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="four" style="cursor: pointer;">[]</span>
        <span class="five" style="cursor: pointer;">[]</span>
         <span class="six" style="cursor: pointer;">[]</span>
          <span class="seven" style="cursor: pointer;">[]</span>
      
      </div>
					<img id="change-image" src="abu1.png" width="100%" style="margin: 0 auto;padding-bottom:30px-webkit-filter: grayscale(100%); /* Safari 6.0 - 9.0 */
