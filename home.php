...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','home1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','home2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','home3.png');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','home11.png');
     }
 });
 
 $('.five').on({
     'click': function(){
         $('#change-image').attr('src','home5.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="five" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="home1.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
