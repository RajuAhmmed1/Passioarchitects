...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','sumi1.jpg');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','sumi2.jpg');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','sumi3.jpg');
     }
 });

$('.four').on({
     'click': function(){
         $('#change-image').attr('src','sumi4.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
      ...
      <span class="four" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="sumi1.jpg" width="auto" style="margin: 0 auto;padding-bottom:30px;-webkit-filter: grayscale(100%); /* Safari 6.0 - 9.0 */
