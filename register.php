		...
		<div class="form-v5-content">
			<form class="form-detail" action="register.php" method="post">
				...
				<div class="form-row">
					...
					<input type="text" name="username" id="full-name" class="input-text" placeholder="username" value="<?php echo $username; ?>" required>
					<i class="fas fa-user"></i>
				</div>
				<div class="form-row">
					<label for="your-email">your email</label>
					<input type="email" id="your-email" class="input-text" placeholder="your email" name="email" value="<?php echo $email; ?>" >
				...
				<div class="form-row-last">
					<input type="submit" name="reg_user" class="register" value="submit">
				</div>
				<p>
