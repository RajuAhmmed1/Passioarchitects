...
<html>
<head>
  <title>shuchana center point</title>
  <meta charset="utf-8">
...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','suchona.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','sucona2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','sucona3.png');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','sucona4.png');
     }
 });
 
 $('.five').on({
     'click': function(){
         $('#change-image').attr('src','sucona5.png');
     }
 });

  $('.six').on({
     'click': function(){
         $('#change-image').attr('src','sucona6.png');
     }
 });
   $('.seven').on({
     'click': function(){
         $('#change-image').attr('src','sucona7.jpg');
     }
 });
});
        ...
        <span class="five" style="cursor: pointer;">[]</span>
         <span class="six" style="cursor: pointer;">[]</span>
          <span class="seven" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="suchona.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
