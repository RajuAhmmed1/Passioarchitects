...
<html>
<head>
  <title>tech-ven-moon-light</title>
  <meta charset="utf-8">
...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','tec1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','tec2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','tec3.png');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','tec4.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="four" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="tec1.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
