...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','mukta1.jpg');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','mukta22.jpg');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','mukta3.jpg');
     }
 });

$('.four').on({
     'click': function(){
         $('#change-image').attr('src','mukta4.jpg');
     }
 });
...
<?php } ?>
			...
			<div class="row">
				...
				<div class="col-sm-5" style="margin-top: 60px">
					...
					<div class="col-sm-6" id="" style="padding-top:25px;" >
  ...
  <div class="aa" style="height: 20px;margin-bottom: 10px;">
      ...
      <span class="four" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="mukta1.jpg" width="auto" style="margin: 0 auto;padding-bottom:30px;-webkit-filter: grayscale(100%); /* Safari 6.0 - 9.0 */
