...
<html>
<head>
  <title>dunhil-lounge, sheraton</title>
  <meta charset="utf-8">
...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','dun1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','dun2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','dun3.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="three" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="dun1.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
