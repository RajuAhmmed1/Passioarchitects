...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','lak1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','lak.png');
         $("#change-image").css("width", "80%");
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','lak11.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="three" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="lak1.png" width="80%" max-height=""style="margin: 0 auto;padding-bottom:30px">
				</div>
