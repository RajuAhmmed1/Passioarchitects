...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','mahfuj.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','mahfuj2.jpg');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','mahfuj3.png');
     }
 });
...
<?php } ?>
  ...
  <div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="three" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="mahfuj.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
