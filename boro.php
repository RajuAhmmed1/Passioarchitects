...
<html>
<head>
  <title>boromia properties ltd</title>
  <meta charset="utf-8">
...
$('.one').on({
     'click': function(){
         $('#change-image').attr('src','s1.png');
     }
 });
 
$('.two').on({
     'click': function(){
         $('#change-image').attr('src','s2.png');
     }
 });
$('.three').on({
     'click': function(){
         $('#change-image').attr('src','s3.png');
     }
 });
$('.four').on({
     'click': function(){
         $('#change-image').attr('src','s4.png');
     }
 });
 
 $('.five').on({
     'click': function(){
         $('#change-image').attr('src','5555.png');
     }
 });
...
<div class="aa" style="height: 20px;margin-bottom: 10px;">
        ...
        <span class="five" style="cursor: pointer;">[]</span>
					...
					<img id="change-image" src="s1.png" width="100%" style="margin: 0 auto;padding-bottom:30px">
				</div>
