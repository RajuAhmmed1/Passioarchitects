...
<?php } ?>
	...
	<div class="page-content">
		<div class="form-v5-content">
			<form class="form-detail" action="enter_email.php" method="post">
				...
				<div class="form-row">
					...
					<input type="email" name="email" id="full-name" class="input-text"  required>
					<i class="fas fa-envelope"></i>
				</div>
				
				<div class="form-row-last">
          <input type="submit" name="reset-password" class="register" value="submit">
